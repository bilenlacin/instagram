...
export class ProfileMedia extends Component {
  render() {
    return (
      <div className='profileMediaDiv'>
        <div className='mediaHeaders'>
          <div className='mediaHeaderDiv'>
            <a href='' className='mediaHeader'>
            ...
            <a href='' className='mediaHeader'>
              <span className='mediaType'>
                ...
                <span style={{ marginLeft: '6px' }}>IGTV</span>
              </span>
            </a>

            <a href='' className='mediaHeaderl'>
              <span className='mediaType'>
                <svg
                  aria-label=''
                  class='_8-yf5 '
        ...
        <div className='medias'>
          <div className='mediaGridDiv'>
            <div className='mediaDiv'>
              <a href='' className='mediaRef'>
                <div className='mediaType'>
                  <img src='icons/nasaImage1.jpg' alt='' className='media' />
                </div>
              </a>
            </div>
            <div className='mediaDiv g-col-4'>
              <a href='' className='mediaRef'>
                <div className='mediaType'>
                  <img src='icons/nasaImage2.jpg' alt='' className='media' />
                </div>
              </a>
            </div>
            <div className='mediaDiv g-col-4'>
              <a href='' className='mediaRef'>
                <div className='mediaType'>
                  <img src='icons/nasaImage3.jpg' alt='' className='media' />
                </div>
              </a>
            </div>
          </div>

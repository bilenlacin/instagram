          ...
          <div className='comments-container'>
            <div className='modal-comment-container'>
              ...
              <p className='comment'>
                ...
                rare sight captured by @EuropeanSpaceAgency’s @Thom_Astro aboard
                the International Space Station. Incoming energy and particles
                from the sun interacting with Earth’s magnetic field causing
                bursts of light and color across the magnetosphere. In a glowing
                aurora, we see billions of these individual collisions of energy
                lighting up the sky – a breathtaking phenomenon that can also be
                observed from space. The colors of an aurora can vary depending
                on which gas is excited and how much energy is being exchanged,
                and in this case, nitrogen produces the beautiful blue light
                display. Credit: ESA
              </p>
            </div>
          </div>
